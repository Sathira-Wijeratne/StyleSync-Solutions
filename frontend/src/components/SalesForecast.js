    ...
    <div>
      ...
      <div className="container">
        ...
        <center>
          ...
          Enter the product price along with the size of the product that you
          want to get the sales forecast
          <br />
          <br />
          <table
            className="table"
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      axios
                        .get(
                          `http://localhost:8070/prediction/getratings/XXXXL`
                        )
                        .then((res) => {
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      axios
                        .get(
                          `http://localhost:8070/prediction/getratings/XXXXXL`
                        )
                        .then((res) => {
